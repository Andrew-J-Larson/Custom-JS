...
// @match        *://*.mppclone.com/*
// @supportURL   https://github.com/TheAlienDrew/Custom-JS/tree/master/!-User-Scripts/Multiplayer%20Piano/MIDI-Player/Minecraft-Music
...
/* MAY NOT NEED */ //exists(event.noteName) ? MIDIPlayerToMPPNote[event.noteName] : null
    ...
    if (sustainOption && (currentEvent == "Note off" || event.velocity == 0)) {
