...
// @updateURL    https://raw.githubusercontent.com/TheAlienDrew/Tampermonkey-Scripts/master/Poolsuite%20FM/Poolsuite-FM-Minecraft-DLC/Poolsuite-FM-Minecraft-DLC.user.js
// @downloadURL  https://raw.githubusercontent.com/TheAlienDrew/Tampermonkey-Scripts/master/Poolsuite%20FM/Poolsuite-FM-Minecraft-DLC/Poolsuite-FM-Minecraft-DLC.user.js
// @icon         https://raw.githubusercontent.com/TheAlienDrew/Tampermonkey-Scripts/master/Poolsuite%20FM/Poolsuite-FM-Minecraft-DLC/favicons/favicon_dithered_tampermonkey.png
...
const PS_FM_RESOURCES_LINK = "https://raw.githubusercontent.com/TheAlienDrew/Tampermonkey-Scripts/master/Poolsuite%20FM/";
const APP_SPLASH = "https://raw.githubusercontent.com/TheAlienDrew/minecraft-classic/master/splash/mojang.png";
const APP_RAW_LINK = PS_FM_RESOURCES_LINK + "Poolsuite-FM-Minecraft-DLC/";
...
const STYLE_BASIC_IFRAME = "border: 1px solid #000; -appkit-box-shadow: inset 1px 1px 0 0 #fff, 5px 5px 0 rgba(0,0,0,.2); box-shadow: inset 1px 1px 0 0 #fff, 5px 5px 0 rgba(0,0,0,.2);"; // fix brightness?: -webkit-filter: brightness(100%); filter: brightness(100%);
...
var convertToMinecraft = function() {
    ...
    // replace Poolsuite TV with the app
    replaceIframe();
