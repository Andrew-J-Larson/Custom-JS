...
requestMPJS.open('GET', MIDIPlayerJS_URL, true);
requestMPJS.send(null);
requestMPJS.onreadystatechange = function () {
    if (requestMPJS.readyState === 4 && requestMPJS.status === 200) {
...
// The MIDIPlayer
var PlayerSet = setInterval(function() {
